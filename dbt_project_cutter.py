...
def input_dialog():
    user_name = input('User Name (snumber):')
    repo_local_directory = input('Repo Local Directory (e.g /temp/): ')
    dbt_fork_url = input('DBT Fork URL(e.g https://github.com/yourname/project/snumber/project_root_folder):')
...
def project_temp_copy():
    
    pass
# open a file and replace {{ name }} with a value
# date, creator, project_name, source_schema
...
# user_name = 's106916'
# repo_local_directory = '/temp/abc'
# dbt_fork_url = 'https://github.com/yourname/project/.git'
# project_name = 'testgood'
...
for f in files:
    ...
    _p = os.path.join(p, data_domain,project_name, f).replace('schema',source_schema)
